        ...
        <RoundedCard flex>
          ...
          <RoundedCard flex className="border">
            <p>
              ...
              <br /> <br />
              Through frame-by-frame analysis of blue light, luminosity, and
              ...
              market available to those that are photosensitive.
              <br /> <br />
              We hope that this tool will allow game developers to reach a wider
              audience, and allow more people to enjoy video games.
              <br /> <br />
              Algorithm details: <br /> Sightline averages the luminosity of
              every frame to determine if the video flashes six times or more in
              second. If it does, that could cause a seizure. It also sums the
              number of pixels that are in the hue range of damaging blue light
              in every frame by checking whether each pixel in a frame has a hue
              between 200 and 211.
            </p>
          </RoundedCard>
        </RoundedCard>
